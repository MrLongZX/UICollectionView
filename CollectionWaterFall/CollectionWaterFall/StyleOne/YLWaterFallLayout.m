...
/** 默认的列数 */
static const CGFloat kDefaultColunmCount = 2;

/** 每一列之间的间距 */
static const CGFloat kDefaultColunmMargin = 16;

/** 每一行之间的间距 */
static const CGFloat kDefaultRowMargin = 16;

/** 内边距 */
static const UIEdgeInsets kDefaultEdgeInsets = {16 , 16 , 0, 16};
...
- (CGSize)collectionViewContentSize
{
    ...
    return CGSizeMake(contentWidth, self.contentHeight + self.edgeInsets.bottom);
}
